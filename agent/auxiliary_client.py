...
def _relay_sync_completion(
    ...
    *,
    ...
    task_fence_route_provider: str | None = None,
) -> Any:
    callback = create or (
        lambda request: _task_fence_sync_model_create(
            client,
            request,
            route_provider=task_fence_route_provider or provider,
            task_fence_model_policy=task_fence_model_policy,
        )
    )
    ...
    try:
        return _validate_llm_response(
            _relay_sync_completion(
                ...
                provider=fb_label,
                task_fence_model_policy=task_fence_model_policy,
                task_fence_route_provider=fb_label,
            ),
            task,
        )
                ...
                try:
                    return _validate_llm_response(
                        _relay_sync_completion(
                            ...
                            task_fence_model_policy=task_fence_model_policy,
                            task_fence_route_provider=fb_provider,
                        ),
                        task,
                    )
                ...
                try:
                    return _validate_llm_response(
                        _relay_sync_completion(
                            ...
                            api_mode=resolved_api_mode,
                            task_fence_model_policy=task_fence_model_policy,
                            task_fence_route_provider=resolved_provider or "nous",
                        ),
                        task,
                    )
                except Exception as retry_err:
